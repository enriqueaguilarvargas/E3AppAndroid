...
namespace E3AppAndroid
{
    ...
    public class MainActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle? savedInstanceState)
        {
            ...
            Intent objIntent = new Intent(this, typeof(ActivitySql));
            objIntent.PutExtra("Usuario", "Enrique Aguilar");
            ...
            btnAlmacenar.Click += delegate
            {
                try
                {
                    ...
                    var API = "http://192.168.0.111:85/Principal/AlmacenarSQLServer?Nombre=" +
            ...
            btnConsultar.Click += async delegate
            {
                try
                {
                    ...
                    var API = "http://192.168.0.111:85/Principal/ConsultarSQLServer?ID=" + ID;
